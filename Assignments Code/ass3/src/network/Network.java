...
public class Network {
     ...
     * If the stop is already in the list, a DuplicateStopException should be
     * thrown
     *
     ...
     * @throws DuplicateStopException If any of the stops already exist int the
     *                              network. If there are any duplicate stops,
     *                              none of the stops should be added.
     */
