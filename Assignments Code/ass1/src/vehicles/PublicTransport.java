...
public abstract class PublicTransport {
    ...
    public void addPassenger(Passenger passenger) throws OverCapacityException {
        if ( Objects.nonNull( passenger ) ) {
            if ( this.passengerCount() < this.getCapacity() ) { //has not reached capacity
                this.passengers.add(passenger); // add passenger to the vehicle
            } else {
                throw new OverCapacityException();//has reached capacity, throws OverCapacityException
            }
        }
    }
